...
const SEED_ALERTS: Alert[] = [
  ...
  },
  {
    ...
    channel: "dashboard",
    type: "news",
    title: "Fed Headline Watch",
    message: "Research agent flagged macro headline — review AAPL, EURUSD",
    severity: "medium",
    read: false,
  ...
  },
  {
    ...
    channel: "dashboard",
    type: "economic",
    title: "CPI Release Tomorrow",
    message: "Economic calendar event — reduce paper size pre-release",
    severity: "medium",
    read: false,
  ...
  },
  {
    ...
    message: "Portfolio manager recommends reducing tech concentration",
    severity: "low",
    read: false,
